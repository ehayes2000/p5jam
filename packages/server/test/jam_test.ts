...
// const ownerServer = makeJamRoutes(authorizeUser('testUserOwner'))
// const ownerClient = treaty(ownerServer)
// const participantServer = makeJamRoutes(authorizeUser('testUserParticipant'))
// const participantClient = treaty(ownerServer)
...
//   })
//   test('jam data', async () => {
//     const { data } = await ownerClient.jams.get()
//     expect(data).not.toBe(null)
